...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $row = getNV($id);//lấy thông tin nhân viên theo id   
        ?>    
        <form name="form1" method="post" action="XulySuaNV.php" enctype="multipart/form-data" onsubmit="return kiemtra();">
            ...
            <table width="446" border="0" align="center" cellpadding="5" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="Images/<?=$hinhanh?>" width="80"><br>
                        <input type="text" name="tAnhhientai" id="tAnhhientai" value="<?=$row["hinhanh"]?>" readonly> <!--readonly: người dùng ko thể chỉnh sửa ô input này-->
                    </td>
                </tr>
                <tr>
                    <td>Hình ảnh mới : </td>
