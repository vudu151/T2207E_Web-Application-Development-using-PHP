...
<div class="content">
    <h2 class="title__heading">Danh sách tác giả</h2>
    <div class="grid">
        <div class="container">
            <table id="cart" class="table table-bordered tbale-condensed">
                ...
                <tbody>
                    ...
                    $total_records = $author->GetSumAuthor();
                    ...
                    $author->GetAuthorListByLocation($start,$limit);
                    $rowsAuthor = $author->data;
                    if($rowsAuthor==NULL)
                        die("<h3> KHÔNG CÓ SẢN PHẨM NÀO </h3>");
                    foreach($rowsAuthor as $row)
                    {
                    ?>
                    <tr class="py-3">
                        <td>
                        ...
                        <td>
                            <p class="button-cell">
                                <button class="edit-button">
                                    <a href="?module=author&act=fix&id=<?=$row["Id"]?>"><i class="fa fa-edit"></i></a>
                                </button>
                                <button class="delete-button">
                                    <a href="?module=author&act=delete&id=<?=$row["Id"]?>"><i class="fa fa-trash-alt"></i></a>
                                </button>
                            </p>
                        </td>
                    </tr>
                    ...
                    <div class="pager">
                        ...
                        {
                            $CSS_OffButtonDau = "href='?module=author&page=1'";
                            $CSS_OffButtonTruoc = "href='?module=author&page=$page'";
                        }
                        ...
                        ?>
                        |<a href="?module=author&page=<?=$page?>" <?=$CSS_curPage?>> <?=$page?> </a> 
                        <?php
                        }
                        ...
                        {
                            $CSS_OffButtonCuoi = "href='?module=author&page=$total_pages'";
                            $CSS_OffButtonTiep = "href='?module=author&page=$page'";
                        }
                        ?>
