<?php
    ...
    class clsSanpham  extends clsDatabase
    {
        ...
        {
            parent::__construct(); //Gọi hàm tạo của lớp clsDatabase(lớp cha) để kết nối CSDL
            $this->data= null;
        }
        //Các hàm truy vấn CRUD
        //Hàm LayDanhsachSanpham() để truy vấn dữ liệu vào data của lớp
        function LayDanhsachSanpham()
        {
            $sql = "SELECT * FROM books";
            $ketqua = $this->ThucthiSql($sql);//Gọi ThucthiSql kế thừa từ lớp clsDatabase
